...
{
    // public static BackStoryScript Instance;
    public List<string> script = new List<string>
    {
        ...
        "Somehow, he even picks up a chair and throws it at Alex, which she somehow dodges.\nAlex was impressed both at her own dodging ability and at the raw strength of this terrifying bloodthirsty toddler.",
        ...
        "Eugene slowly exits the house and approaches her, anger in his eyes. This is dangerous, she thinks. She didn't even want to do this job. She didn't need it in the first place. This was just a favor to a family friend.",
        "The logical solution would be to flee. Alex knows this. But she still feels responsible.\nThe same sense of responsibility that kept her on track with all of her art commissions was telling her that she had to finish this job, and she had to finish it correctly, with a safe unhurt toddler.",
